...
export const CardShadow = ({ dragging }: { dragging: DOMRect }) => (
  <div
    className="flex-shrink-0 rounded bg-gray-900"
...
const CardDisplay = ({
  ...
  >
    ...
    <div
      ref={innerRef}
      className={clsx(
        'rounded bg-gray-700 p-2 text-gray-200 ',
          ...
          <div className="flex ml-2">
            {userdata.map((data, i) => (
              <img
                ...
                src={data.profile}
                alt="user"
                className="h-7 w-7  rounded-full border-2 border-gray-500 ml-[-10px]"
              />
            ))}
          </div>
